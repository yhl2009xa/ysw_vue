<template>
  <div>
    ...
    <!--<h1>Change swipe</h1>-->
    <!--<swipe class="my-swipe" ref="mySwipe2" :auto="1" :continuous="false"  :speed="1000" :show-indicators="false" @change="changeSwipe">-->
      <!--<swipe-item class="slide1">Slide1</swipe-item>-->
      <!--<swipe-item class="slide2">Slide2</swipe-item>-->
      <!--<swipe-item class="slide3">Slide3</swipe-item>-->
    <!--</swipe>-->
...
<script>
  import { Swipe, SwipeItem} from '$libs/swiper/index.js';
